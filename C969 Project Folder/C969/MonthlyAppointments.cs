...
namespace C968
{
    ...
    public partial class MonthlyAppointments : Form
    {
        ...
        {
            InitializeComponent();
            monthlyAppReportDGV.DataSource = report();
        }
        ...
        public static Array report()
        {
            ...
            foreach (var app in DBHelper.getAppointments().Values)
            {
                ...
                if (!duplicate)
                {
                    ...
                    appReport.quantity = DBHelper.getAppointments().Where(
        ...
        private void MonthlyAppointments_FormClosed(object sender, FormClosedEventArgs e)
        {
            Hide();
